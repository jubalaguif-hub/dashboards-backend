...
- Eventlet (servidor assíncrono para WebSockets)
...
- **Start Command**
  ...
  **Nota:** O uso de `eventlet` é necessário para suportar WebSockets. O parâmetro `-w 1` limita a um worker para evitar problemas de concorrência com arquivos JSON.
